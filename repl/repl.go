	...
	for {
		...
		*/
		...
		/*
			...
			io.WriteString(out, "\n")
		*/
		evaluator.DefineMacros(program, macroEnv)             // separate macros and the other parts
		expanded := evaluator.ExpandMacros(program, macroEnv) // expand macros to asts
